...
// from : http://blogs.msdn.com/b/fsharpteam/archive/2011/11/15/updates-to-the-august-2011-f-2-0-compiler-code-drop.aspx
...
type ConsoleControl() as this = 
    inherit UserControl()
    do Application.LoadComponent(this, new System.Uri("/Undertone.ConsoleApp;component/ConsoleControl.xaml", System.UriKind.Relative));
