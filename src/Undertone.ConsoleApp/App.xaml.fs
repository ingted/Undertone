...
namespace Undertone.ConsoleApp
...
type App() as this = 
    inherit Application()
    do Application.LoadComponent(this, new System.Uri("/Undertone.ConsoleApp;component/App.xaml", System.UriKind.Relative));
    let console = new ConsoleControl()
//    let syncContext = new DispatcherSynchronizationContext()
//    do DispatcherSynchronizationContext.SetSynchronizationContext syncContext
